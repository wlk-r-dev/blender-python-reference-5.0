...
[Launching from the Command Line](https://docs.blender.org/manual/en/dev/advanced/command_line/launch/index.md#command-line-launch-index "\(in Blender 5.1 Manual v5.1\)").
