...
_class _bpy.types.AnnotationLayers(_bpy_struct_)
...
**layer** ([`AnnotationLayer`](bpy.types.AnnotationLayer.md#bpy.types.AnnotationLayer "bpy.types.AnnotationLayer"), (never None)) – The layer to remove
