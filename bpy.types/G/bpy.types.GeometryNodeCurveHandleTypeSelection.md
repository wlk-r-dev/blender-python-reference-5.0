...
enum set in [Node Geometry Curve Handle Side Items](../../bpy_types_enum_items/node_geometry_curve_handle_side_items.md#rna-enum-node-geometry-curve-handle-side-items), default set()
