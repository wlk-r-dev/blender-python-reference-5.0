...
_class _bpy.types.NodeClosureInputItems(_bpy_struct_)
...
[`NodeClosureInputItem`](bpy.types.NodeClosureInputItem.md#bpy.types.NodeClosureInputItem "bpy.types.NodeClosureInputItem")
...
**item** ([`NodeClosureInputItem`](bpy.types.NodeClosureInputItem.md#bpy.types.NodeClosureInputItem "bpy.types.NodeClosureInputItem"), (never None)) – Item, The item to remove
...
## References
  ...
  * [`NodeClosureOutput.input_items`](bpy.types.NodeClosureOutput.md#bpy.types.NodeClosureOutput.input_items "bpy.types.NodeClosureOutput.input_items")
