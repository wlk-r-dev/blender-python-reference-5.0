...
_class _bpy.types.NodeSeparateBundleItems(_bpy_struct_)
...
**item** ([`NodeSeparateBundleItem`](bpy.types.NodeSeparateBundleItem.md#bpy.types.NodeSeparateBundleItem "bpy.types.NodeSeparateBundleItem"), (never None)) – Item, The item to remove
