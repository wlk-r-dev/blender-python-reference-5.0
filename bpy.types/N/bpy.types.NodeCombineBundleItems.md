...
_class _bpy.types.NodeCombineBundleItems(_bpy_struct_)
...
**item** ([`NodeCombineBundleItem`](bpy.types.NodeCombineBundleItem.md#bpy.types.NodeCombineBundleItem "bpy.types.NodeCombineBundleItem"), (never None)) – Item, The item to remove
