...
_class _bpy.types.NodeSeparateBundle(_NodeInternal_)
...
[`NodeSeparateBundleItems`](bpy.types.NodeSeparateBundleItems.md#bpy.types.NodeSeparateBundleItems "bpy.types.NodeSeparateBundleItems") [`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeSeparateBundleItem`](bpy.types.NodeSeparateBundleItem.md#bpy.types.NodeSeparateBundleItem "bpy.types.NodeSeparateBundleItem"), (readonly)
