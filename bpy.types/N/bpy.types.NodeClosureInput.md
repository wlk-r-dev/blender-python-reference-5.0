...
_class _bpy.types.NodeClosureInput(_NodeInternal_)
...
**output_node** ([`NodeInternal`](bpy.types.NodeInternal.md#bpy.types.NodeInternal "bpy.types.NodeInternal")) – Output Node, Zone output node to pair with
