...
_class _bpy.types.NodeCompositorFileOutputItems(_bpy_struct_)
...
**item** ([`NodeCompositorFileOutputItem`](bpy.types.NodeCompositorFileOutputItem.md#bpy.types.NodeCompositorFileOutputItem "bpy.types.NodeCompositorFileOutputItem"), (never None)) – Item, The item to remove
