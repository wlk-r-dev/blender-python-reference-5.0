...
_class _bpy.types.NodeCombineBundle(_NodeInternal_)
...
[`NodeCombineBundleItems`](bpy.types.NodeCombineBundleItems.md#bpy.types.NodeCombineBundleItems "bpy.types.NodeCombineBundleItems") [`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeCombineBundleItem`](bpy.types.NodeCombineBundleItem.md#bpy.types.NodeCombineBundleItem "bpy.types.NodeCombineBundleItem"), (readonly)
