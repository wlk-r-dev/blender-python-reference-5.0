...
_class _bpy.types.NodeGeometryViewerItems(_bpy_struct_)
...
**item** ([`NodeGeometryViewerItem`](bpy.types.NodeGeometryViewerItem.md#bpy.types.NodeGeometryViewerItem "bpy.types.NodeGeometryViewerItem"), (never None)) – Item, The item to remove
