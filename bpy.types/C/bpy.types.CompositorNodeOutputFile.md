...
string, default “”, (never None, Supports [template expressions](https://docs.blender.org/manual/en/5.0/files/file_paths.md#path-templates))
...
[`NodeCompositorFileOutputItems`](../N/bpy.types.NodeCompositorFileOutputItems.md#bpy.types.NodeCompositorFileOutputItems "bpy.types.NodeCompositorFileOutputItems") [`bpy_prop_collection`](../_other/bpy.types.bpy_prop_collection.md#bpy.types.bpy_prop_collection "bpy.types.bpy_prop_collection") of [`NodeCompositorFileOutputItem`](../N/bpy.types.NodeCompositorFileOutputItem.md#bpy.types.NodeCompositorFileOutputItem "bpy.types.NodeCompositorFileOutputItem"), (readonly)
